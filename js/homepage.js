...
function generateHomepage(){
	...
	footer.innerHTML=`<a href="#"><img src="img/logo_mic.png"></a>
               <p>Copyright 2017  - Pravalia cu povesti</p>`
...
//console.log(filterByValue(data, 'lea')); // [{name: 'Lea', country: 'Italy'}]
//console.log(filterByValue(data, 'ita')); // [{name: 'Lea', country: 'Italy'}, {name: 'John', country: 'Italy'}]
	...
	function filterByValue(array, string) {
   	for (var i = 0; i < array.length; i++) {
   		var x = array[i].content.search(string)
   		console.log("x is" + x)
   	}
